...
<div class="container mt-4">
    <div class="card shadow-lg border-0 rounded-4 p-4" style="background: #ffffff; border-top: 5px solid black;">
        <h4 class="fw-bold text-dark mb-4">Edit Company</h4>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <input type="url" name="website" value="{{ $company->website }}" class="form-control" required>
                    </div>
                </div>
            </div>

            <div class="mt-4">
                <button type="submit" class="btn btn-dark add-company-btn">Update</button>
